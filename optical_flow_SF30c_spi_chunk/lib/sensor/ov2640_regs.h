...
#define COM2_OUT_DRIVE_2x   0x02
#define COM2_OUT_DRIVE_3x   0x01
...
#define COM9_AGC_SET(x)  ( (COM9_DEFAULT & ~0xE0) | (((x) & 0x07) << 5) )
...
#define CLKRC_2X            0x80 /* (คูณความถี่ XVCLK x 2 ก่อนนำไปหาร) */
